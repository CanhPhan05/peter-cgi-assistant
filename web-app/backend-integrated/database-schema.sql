-- Peter CGI Assistant - Integrated Database Schema
...
-- Note: This is just for testing, real users come from external auth system

/*
INSERT INTO user_settings (user_id, api_key) VALUES 
('demo_user_hash', 'encrypted_demo_key');

INSERT INTO conversations (user_id, user_email, title) VALUES 
('demo_user_hash', 'demo@peter-cgi.com', 'Demo Conversation');
*/ 